...
insert into "PRODUCTS"(id,name) values (35455,'Pantalón vaquero');
...
insert into "PRICES"(BRAND_ID,START_DATE,END_DATE,PRICE_LIST,PRODUCT_ID,PRIORITY,PRICE,CURR) values (1,'2020-06-15T16:00:00','2020-12-31T23:59:59',4,35455,1,38.50,'EUR');